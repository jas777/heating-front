...
const ModeButton = styled(Pressable)<{ auto: boolean; dark: boolean }>`
...
const HeaterCard = (
  ...
  return (
    <CardView>
      <ModeButton auto={isAuto} dark={dark} onPress={toggle}>
      ...
      <ButtonView>
        <EnableButton dark={dark} onPress={enable}>
          <Text style={{ color: 'white', fontSize: 20 }}>Włącz</Text>
        </EnableButton>
        <DisableButton dark={dark} onPress={disable}>
